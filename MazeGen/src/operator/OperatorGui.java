 ...
 * OperatorGUI.java
 * 
 * Creates the user control window for a robot. Draws the maze
 * as generated by the environment. Draws all the robots too.
 * 
 * Note: This class will not draw the maze until it connects
 * to the BlokeIDE timing servers.
 * 
